    ...
    def callback(event):
        ...
        if game_log.turn==1:
            ...
            if tmp_point_2d[0]<1 or tmp_point_2d[0] >24 or tmp_point_2d[1] < 1 or tmp_point_2d[1] > 24:
                ...
                canvas.create_arc(game_log.cursetX-10,game_log.cursetY-10 , game_log.cursetX+10, game_log.cursetY+10, extent=359, fill='black')
            ...
            if tmp_point_2d[0] < 1 or tmp_point_2d[0] > 24 or tmp_point_2d[1] < 1 or tmp_point_2d[1] > 24:
                ...
                canvas.create_arc(game_log.cursetX-10,game_log.cursetY-10 , game_log.cursetX+10, game_log.cursetY+10, extent=359,fill='white')
